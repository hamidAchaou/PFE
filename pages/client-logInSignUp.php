...
<head>
    ...
    <!-- login signup css -->
    <link rel="stylesheet" href="../asset/css/client-loginSignup.css">
...
<body>
    ...
    <main class="w-100" id="main-login">
        <div class="d-flex log container mt-5">
            ...
            <div class="rounded p-5 w-75 signupForm" id="form-login">
                ...
                <?php include "../element/client-signUpForm.php" ?>
                <!-- ================== end get form signup ================== -->

                <!-- ================== start get form signup ================== -->
                <?php include "../element/client-loginForm.php" ?>
                <!-- ================== end get form signup ================== -->
    ...
    <!-- Template Javascript -->
    <script src="../asset/javascript/client-LogInSingnUp.js"></script>
